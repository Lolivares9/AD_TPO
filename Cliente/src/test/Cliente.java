...
//		iniciarPartidaLibreIndividual(part);
	...
	private static void ronda3(PartidoDTO part) throws ComunicationException, GrupoException {
		...
		TurnoDTO turno1 = new TurnoDTO(null,pareja1Jug1,Envite.Nada,Envite.Nada,part.getParejaDTOs().get(0).getCartasJug1().get(3),1);
		TurnoDTO turno2 = new TurnoDTO(null,pareja2Jug1,Envite.Nada,Envite.Nada,part.getParejaDTOs().get(1).getCartasJug1().get(3),2);
		TurnoDTO turno3 = new TurnoDTO(null,pareja1Jug2,Envite.Nada,Envite.Nada,part.getParejaDTOs().get(0).getCartasJug2().get(3),3);
		TurnoDTO turno4 = new TurnoDTO(null,pareja2Jug2,Envite.Nada,Envite.Nada,part.getParejaDTOs().get(1).getCartasJug2().get(3),4);
		turnos.add(turno1);
		turnos.add(turno2);
		turnos.add(turno3);
		turnos.add(turno4);
	...
	private static void ronda2(PartidoDTO part) throws ComunicationException, GrupoException {
		...
		JugadorDTO pareja2Jug2 = part.getParejaDTOs().get(1).getJugadorDTO2();
		List <TurnoDTO> turnos = new ArrayList<TurnoDTO>();
		TurnoDTO turno1 = new TurnoDTO(null,pareja1Jug1,Envite.Nada,Envite.Nada,part.getParejaDTOs().get(0).getCartasJug1().get(1),1);
		TurnoDTO turno2 = new TurnoDTO(null,pareja2Jug1,Envite.Nada,Envite.Truco,null,2);
		TurnoDTO turno3 = new TurnoDTO(null,pareja1Jug2,Envite.Nada,Envite.Truco_Querido,null,3);
		TurnoDTO turno4 = new TurnoDTO(null,pareja2Jug2,Envite.Nada,Envite.Nada,null,4);
		turnos.add(turno1);
		turnos.add(turno2);
		turnos.add(turno3);
		turnos.add(turno4);
	...
	private static void ronda11(PartidoDTO part) throws ComunicationException, GrupoException {
		...
		JugadorDTO pareja2Jug2 = part.getParejaDTOs().get(1).getJugadorDTO2();
		List <TurnoDTO> turnos = new ArrayList<TurnoDTO>();
		TurnoDTO turno1 = new TurnoDTO(1,pareja1Jug1,Envite.Nada,Envite.Nada,part.getParejaDTOs().get(0).getCartasJug1().get(0),1);
		TurnoDTO turno2 = new TurnoDTO(2,pareja2Jug1,Envite.Nada,Envite.Nada,part.getParejaDTOs().get(1).getCartasJug1().get(0),2);
		TurnoDTO turno3 = new TurnoDTO(3,pareja1Jug2,Envite.Envido,Envite.Nada,part.getParejaDTOs().get(0).getCartasJug2().get(0),3);
		TurnoDTO turno4 = new TurnoDTO(4,pareja2Jug2,Envite.Envido_Querido,Envite.Nada,part.getParejaDTOs().get(1).getCartasJug2().get(0),4);
		turnos.add(turno1);
		turnos.add(turno2);
		turnos.add(turno3);
		turnos.add(turno4);
